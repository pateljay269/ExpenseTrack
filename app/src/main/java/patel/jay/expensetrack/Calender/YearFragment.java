...
public class YearFragment extends Fragment {
    ...
    public static void setRv(Activity context, RecyclerView rvCat) {
        if (MyConstants.DASH_CLICK.equalsIgnoreCase(MyConstants.BAL)) {
            ArrayList<SqlBalAccount> accountArrayList = SqlCalenderBal.yearWise(context);
            CalenderBalAdapter balAdapter = new CalenderBalAdapter(accountArrayList, context, MyConstants.year);
            ...
            ArrayList<SqlRecharge> rechargeArrayList = SqlCalenderRec.yearWise(context);
            CalenderRecAdapter recAdapter = new CalenderRecAdapter(rechargeArrayList, context, MyConstants.year);
            ...
            ArrayList<SqlExTrans> accountArrayList = SqlExCalender.yearWise(context, MyConstants.accName);
            CalenderExAdapter adapter = new CalenderExAdapter(accountArrayList, context, MyConstants.year);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = SetRvCalender.setExView(getActivity(), inflater, container, MyConstants.year);
        return view;
    }
}
