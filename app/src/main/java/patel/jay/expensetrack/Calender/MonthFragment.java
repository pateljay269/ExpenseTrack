...
public class MonthFragment extends Fragment {
    ...
    public static void setRv(Activity context, RecyclerView rvCat) {
        if (MyConstants.DASH_CLICK.equalsIgnoreCase(MyConstants.BAL)) {
            ArrayList<SqlBalAccount> accountArrayList = SqlCalenderBal.monthWise(context);
            CalenderBalAdapter balAdapter = new CalenderBalAdapter(accountArrayList, context, MyConstants.month);
            ...
            ArrayList<SqlRecharge> rechargeArrayList = SqlCalenderRec.monthWise(context);
            CalenderRecAdapter recAdapter = new CalenderRecAdapter(rechargeArrayList, context, MyConstants.month);
            ...
            ArrayList<SqlExTrans> accountArrayList = SqlExCalender.monthWise(context, MyConstants.accName);
            CalenderExAdapter adapter = new CalenderExAdapter(accountArrayList, context, MyConstants.month);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = SetRvCalender.setExView(getActivity(), inflater, container, MyConstants.month);
        return view;
    }
}
